...
router.get('/api/countries', (req, res) => {
    ...
    if (req.query.sort) {
        sortedCountries = [...countries].sort(compareAlphabetically);
    ...
    //     html += `
    //     <div class="card">
    //     <img src="/flags/${countries[i].alpha2Code}.png" style="width:128px">
    //     <div class="container">
    //       <h4><b>${countries[i].name}</b></h4> 
    //       <p>${countries[i].alpha2Code}</p> </b>
    //       <p>${countries[i].alpha3Code}</p> 
    //     </div>
    //   </div>`
    // }
